...
def generate_launch_description():
    ...
    robot_description_semantic_config = load_file(
        "my_moveit_config", "config/ur10e-test.srdf"
    )
    ...
    kinematics_yaml = load_yaml(
        "my_moveit_config", "config/kinematics.yaml"
    )
    ...
    #     "my_moveit_config", "config/ompl_planning.yaml"
    # )
    ompl_planning_pipeline_config["move_group"].update(ompl_planning_yaml)

    # MoveIt!2 Controllers:
    moveit_simple_controllers_yaml = load_yaml(
        "my_moveit_config", "config/moveit_controllers.yaml"
    )
    moveit_controllers = {
    ...
    rviz_base = os.path.join(get_package_share_directory("my_moveit_config"), "launch")
    rviz_full_config = os.path.join(rviz_base, "my_moveit_config.rviz")
    rviz_node_full = Node(
        package="rviz2",
        executable="rviz2",
        name="rviz2",
