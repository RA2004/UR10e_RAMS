...
def generate_launch_description():
    ...
    rviz_base = os.path.join(os.path.join(get_package_share_directory("my_moveit_config"),"config"))
    ...
    # parameters=[params, "/home/rajammu/ros2/test_ws/src/my_moveit_config/config/ros2_controllers.yaml"],
    # )
    ...
    return LaunchDescription([
        ...
        #     event_handler = OnProcessExit(
        #         target_action =  load_joint_state_controller,
        #         on_exit = [generate_demo_launch(moveit_config)],
